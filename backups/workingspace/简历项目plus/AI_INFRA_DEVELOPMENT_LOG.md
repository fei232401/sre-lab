...
> **时间跨度**: 2026年6月20日 ~ 2026年6月22日（实际约20小时高强度开发+验证）
...
6. [三项目如何联动](#六三项目联动统一异构调度系统)
7. [涉及的技术领域与原理](#七涉及的技术领域与原理)
8. [踩坑全记录](#八踩坑全记录)
9. [项目管理与工程思维](#九项目管理与工程思维)
10. [如果重新做一遍——复盘反思](#十如果重新做一遍复盘反思)
...
AI Model Scheduler (:9000)        ← 智能路由层
  │
  ├──→ Backend A: AI Infra Gateway Ollama (:11434)
  │        └──→ RTX 4060 Laptop, qwen2.5:0.5b
  │
  ├──→ Backend B: Ollama Instance B (:11435)
  │        └──→ RTX 4060 Laptop, qwen2.5:1.5b
  │
  ├──→ Backend C: Mock vLLM (:11436)
  │        └──→ 模拟云GPU RTX 4090特征
  │
  └──→ Backend D: SRE-LAB K3S Ollama (未来)
           └──→ StatefulSet + HPA + PVC
```
